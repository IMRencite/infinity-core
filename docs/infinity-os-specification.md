...
| **Website Build Worker Foundation v1** | `lib/infinity/website-builder/` — deterministic templates, honest content markers, foundation a11y/SEO/security checks, internal source packages, `website_build_metadata`; canonical origin `https://example.invalid`; Mission Runtime observes completion after QA — workers do not advance lifecycle |
