    ...
    sections: [
      {
        ...
        rows: [
          ...
          { label: "Last successful read", value: fmt(artifact.metadata.lastSuccessfulRead) },
          { label: "Domain count", value: fmt(artifact.metadata.domainCount) },
          { label: "Next expiration", value: fmt(artifact.metadata.nextExpiration) },
          { label: "Zone count", value: fmt(artifact.metadata.zoneCount) },
          { label: "Record count", value: fmt(artifact.metadata.recordCount) },
